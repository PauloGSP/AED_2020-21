  ...
  {  //para cada simbolo
    ...
    {// se é possivel chamar a recursiva ou incrementar o número de soluções
      ...
      { //se não há mais bits chegamos à solução
        ...
        /*printf("Encoded %s \n",_encoded_message_);
        printf("Decoded  ");
        for (int b=0; b<decoded_idx+1; b++){
          printf("%d",_decoded_message_[b]);
        }
        printf("\n");
        printf("Original ");
        for (int b=0; b<_original_message_size_; b++){
          printf("%d",_original_message_[b]);
        }
        printf("\n ");
*/
      }
